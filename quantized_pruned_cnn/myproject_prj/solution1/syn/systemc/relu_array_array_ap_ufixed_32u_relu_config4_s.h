...
struct relu_array_array_ap_ufixed_32u_relu_config4_s : public sc_module {
    ...
    sc_signal< sc_lv<6> > tmp_data_V_140_reg_1687;
    sc_signal< sc_lv<6> > tmp_data_V_2_reg_1692;
    sc_signal< sc_lv<6> > tmp_data_V_3_reg_1697;
    sc_signal< sc_lv<6> > tmp_data_V_4_reg_1702;
    sc_signal< sc_lv<6> > tmp_data_V_5_reg_1707;
    sc_signal< sc_lv<6> > tmp_data_V_6_reg_1712;
    sc_signal< sc_lv<6> > tmp_data_V_7_reg_1717;
    sc_signal< sc_lv<6> > tmp_data_V_8_reg_1722;
    sc_signal< sc_lv<6> > tmp_data_V_9_reg_1727;
    sc_signal< sc_lv<6> > tmp_data_V_10_reg_1732;
    sc_signal< sc_lv<6> > tmp_data_V_11_reg_1737;
    sc_signal< sc_lv<6> > tmp_data_V_12_reg_1742;
    sc_signal< sc_lv<6> > tmp_data_V_13_reg_1747;
    sc_signal< sc_lv<6> > tmp_data_V_14_reg_1752;
    sc_signal< sc_lv<6> > tmp_data_V_15_reg_1757;
    sc_signal< sc_lv<6> > tmp_data_V_16_reg_1762;
    sc_signal< sc_lv<6> > tmp_data_V_17_reg_1767;
    sc_signal< sc_lv<6> > tmp_data_V_18_reg_1772;
    sc_signal< sc_lv<6> > tmp_data_V_19_reg_1777;
    sc_signal< sc_lv<6> > tmp_data_V_20_reg_1782;
    sc_signal< sc_lv<6> > tmp_data_V_21_reg_1787;
    sc_signal< sc_lv<6> > tmp_data_V_22_reg_1792;
    sc_signal< sc_lv<6> > tmp_data_V_23_reg_1797;
    sc_signal< sc_lv<6> > tmp_data_V_24_reg_1802;
    sc_signal< sc_lv<6> > tmp_data_V_25_reg_1807;
    sc_signal< sc_lv<6> > tmp_data_V_26_reg_1812;
    sc_signal< sc_lv<6> > tmp_data_V_27_reg_1817;
    sc_signal< sc_lv<6> > tmp_data_V_28_reg_1822;
    sc_signal< sc_lv<6> > tmp_data_V_29_reg_1827;
    sc_signal< sc_lv<6> > tmp_data_V_30_reg_1832;
    sc_signal< sc_lv<6> > tmp_data_V_31_reg_1837;
