...
reduce_ap_ufixed_4_Op_max_ap_ufixed_6_0_0_0_0_s::reduce_ap_ufixed_4_Op_max_ap_ufixed_6_0_0_0_0_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( select_ln86_fu_40_p3 );
    sensitive << ( select_ln86_1_fu_54_p3 );
...
void reduce_ap_ufixed_4_Op_max_ap_ufixed_6_0_0_0_0_s::thread_ap_ready() {
    ap_ready = ap_const_logic_1;
}

void reduce_ap_ufixed_4_Op_max_ap_ufixed_6_0_0_0_0_s::thread_ap_return() {
    ap_return = (!icmp_ln1496_2_fu_62_p2.read()[0].is_01())? sc_lv<6>(): ((icmp_ln1496_2_fu_62_p2.read()[0].to_bool())? select_ln86_1_fu_54_p3.read(): select_ln86_fu_40_p3.read());
}
...
void reduce_ap_ufixed_4_Op_max_ap_ufixed_6_0_0_0_0_s::thread_icmp_ln1496_2_fu_62_p2() {
    icmp_ln1496_2_fu_62_p2 = (!select_ln86_fu_40_p3.read().is_01() || !select_ln86_1_fu_54_p3.read().is_01())? sc_lv<1>(): (sc_biguint<6>(select_ln86_fu_40_p3.read()) < sc_biguint<6>(select_ln86_1_fu_54_p3.read()));
}
