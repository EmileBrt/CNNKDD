...
set DataType10 "[list ap_fixed 16 6 0 0 0 ]"
set Port10 [list $PortName10 $Interface10 $DataType10 $Pointer10 $Dims10 $Const10 $Volatile10 $ArrayOpt10]
lappend structMem1 $Port10
set DataType1tp1 "unsigned int"
set structParameter1 [list [list typename T] [list $DataType1tp1 N] ]
set DataType1ta0 "[list ap_fixed 16 6 0 0 0 ]"
set structArgument1 [list $DataType1ta0 1 ]
set SpaceName10 "nnet"
set NameSpace1 [list  [list  space $SpaceName10] ]
set structIsPacked1 "0"
set DataType1 [list "nnet::array<ap_fixed<16, 6, 0, 0, 0>, 1>" "struct array" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
